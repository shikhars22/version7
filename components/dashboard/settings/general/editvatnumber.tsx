...
const EditVatNumber = ({ vatnumber }: { vatnumber: string }) => {
	type inputType = {
		vatnumber: string;
	};

	const onSubmit = async (data: inputType) => {
		console.log(data.vatnumber);
	};
	...
	return (
		<div className="flex items-center gap-3 flex-wrap sm:flex-nowrap mb-7">
			...
			<div className="flex items-center justify-between w-full flex-wrap sm:w-1/2">
				<p className="font-[500] text-[15px] text-left">{vatnumber}</p>
